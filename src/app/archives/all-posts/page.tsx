                ...
                {postData.blogPosts.map((post) => {
                    return (
                        <div key={post.id} className="mb-10 p-4 rounded shadow-md bg-white hover:shadow-lg transition-shadow duration-300">
                            ...
                            <p className="text-sm text-gray-500 mb-1">Published: {post.publishedDate}</p>
                            <p className="text-sm text-gray-500 mb-1">By: {post.author?.name}</p>
