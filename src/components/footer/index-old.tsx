...
export function Footer() {
  return (
    <footer className="container pt-20 mt-12 bg-foreground">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex gap-8 sm:gap-24">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 justify-between w-full">
            <div>
              <h2 className="mb-6 text-base font-semibold text-background capitalize">
                Browse
              </h2>
            ...
            <div>
              ...
              <ul className="text-sm font-medium space-y-4">
                ...
                <li>
                  <Link href="/" className="hover:underline">Web 3.0</Link>
                </li>
                <li>
                  <Link href="/" className="hover:underline">Strategies</Link>
                </li>
                <li>
